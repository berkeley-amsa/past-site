...
class JFormFieldEditor extends JFormField
{
	...
	protected function getInput()
	{
		...
		return $editor->display($this->name, htmlspecialchars($this->value, ENT_COMPAT, 'UTF-8'), $width, $height, $cols, $rows, $buttons ? (is_array($buttons) ? array_merge($buttons,$hide) : $hide) : false, array($this->id), $asset, $this->form->getValue($authorField));
	}
