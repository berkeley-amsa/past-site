<?php
/**
 * @version $Id: bbcode.php 3605 2010-10-01 18:10:41Z mahagr $
 * Kunena Component
 * @package Kunena
 *
		...
		<tr>
			...
			<div id="kpoll-hide-not-allowed" <?php if(!$display_poll) { ?> style="display:none;" <?php } ?> >
				...
				<img id="kbutton-poll-add"
					src="<?php echo JURI::root(); ?>/components/com_kunena/template/light/images/icons/poll_add_options.png"
				...
				<img id="kbutton-poll-rem"
					src="<?php echo JURI::root(); ?>/components/com_kunena/template/light/images/icons/poll_rem_options.png"
