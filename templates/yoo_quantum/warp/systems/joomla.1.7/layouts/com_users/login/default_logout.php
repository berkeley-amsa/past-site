...
<div id="system">
	...
	<?php if (($this->params->get('logoutdescription_show') && $this->params->get('logout_description'))|| $this->params->get('logout_image')) : ?>
	...
	<form class="submission small" action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" method="post">
