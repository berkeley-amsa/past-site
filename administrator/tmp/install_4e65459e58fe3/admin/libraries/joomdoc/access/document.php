...
class JoomDOCAccessDocument extends JoomDOCAccess {
    ...
    public static function manage ($checkedOut) {
        return parent::authorise(JOOMDOC_CORE_EDIT, 'com_checkin') || $checkedOut == JFactory::getUser()->id || $checkedOut == 0;
    }
    ...
    public static function authorise ($task, $docid, $path, $sessionid = null) {
        ...
        if ($docid)
            ...
            return parent::authorise($task, JoomDOCHelper::getDocumentAsset($docid), $sessionid);
        // get global access
        return parent::authorise($task, JOOMDOC_OPTION, $sessionid);
    }
}
?>