...
abstract class JHtmlGrid
{
	...
	public static function sort($title, $order, $direction = 'asc', $selected = 0, $task=NULL, $new_direction='asc')
	{
		...
		if ($order == $selected) {
			$html .= JHtml::_('image','images/'.$images[$index], '', NULL, true);
		}
	...
	public static function published($value, $i, $img1 = 'tick.png', $img0 = 'publish_x.png', $prefix='')
	{
		...
		JHtml::_('image','administrator/images/'.$img, $alt, NULL, true).'</a>'
		;
	...
	{
		$image = '<img src="' . JURI::base(true) . '/images/' . $image . '" alt="' . JText::_('JLIB_HTML_SAVE_ORDER', true) . '" />';
