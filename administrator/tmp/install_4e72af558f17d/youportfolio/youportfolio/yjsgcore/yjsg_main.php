...
<body id="stylef<?php echo $default_font_family ?>" class="<?php echo $bg_stripe ?>">
...
<?php require( TEMPLATEPATH.DS."layouts/grids/yjsg1.php");/*grid 1 top1-top5 */ ?>
<!-- end centartop-->
