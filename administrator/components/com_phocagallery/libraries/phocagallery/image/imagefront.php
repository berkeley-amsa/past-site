...
class PhocaGalleryImageFront
{
	...
	*/
	...
	function getRandomImageRecursive($categoryid, $categoryImageOrdering = '', $extImage = 0, $extImageSize = 1) {
        ...
        $query = 'SELECT a.id, a.filename, a.exts, a.extm, a.extw, a.exth, a.extid, c.accessuserid as cataccessuserid' .
		...
		if (isset($imgages[0]->cataccessuserid)) {
			$rightDisplay = PhocaGalleryAccess::getUserRight('accessuserid', $imgages[0]->cataccessuserid, 0, $user->authorisedLevels(), $user->get('id', 0), 1);
		}
