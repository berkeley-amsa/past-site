...
class ModSimpleFileUploaderHelperv13{	
	...
	function getUploadForm(
			...
			$upload_blacklist = $params->get( 'upload_blacklist', '.php .php3 .php4 .phtml .pl .py .jsp .asp .htm .shtml .sh .cgi .exe .bat .cmd .htaccess' );
	...
	function getContent($action) {
		...
		if ($action === "sfuuser") {
			...
			if ($session_username === "") {
				...
				$retVal = "Credentials not found. Please refresh your session.";
				//JText::_('FAIL_REQUEST');
			} else {
