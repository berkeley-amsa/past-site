...
<div class="mobiletoptools">
    ...
    <a class="changemobile" href="<?php echo JURI::base()?>?change_mobile=2" onclick="return confirm('<?php echo JText::_('DESKTOP_MODE')?>');" title="<?php echo JText::_('MOBILE_OFF')?>" ><span><?php echo JText::_('MOBILE_OFF')?></span></a> </div>
